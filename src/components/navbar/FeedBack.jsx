            ...
            <Dialog
                ...
                PaperProps={{
                    ...
                    onSubmit: (event) => {
                        ...
                        // FIX!!! email doesnt work! 
                        // console.log("form data: ", formJson);
                        // const subject = formJson.subject;
                        // const body = `${formJson.description}\n\nRegards,\n${formJson.name}`;
                        // const mailtoLink = `mailto:abishkpatil@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
